...
import { Search, Printer, Plus, Calendar, TrendingUp, Lock, Trash2, MoreVertical, Filter } from 'lucide-react';
...
const ExpeditionList = () => {
    ...
    const stats = {
        ...
        enCentreTri: expeditions.filter(e => ['centre_tri', 'en centre de tri'].includes((e.statut || '').toLowerCase())).length,
